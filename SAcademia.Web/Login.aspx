...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function esqueceuSenha() {
            Shadowbox.open({
                content: '<div id="welcome-msg"><iframe name="interna" scrolling="no" height="310" frameborder="0" width="100%" allowtransparency="true" src="SolicitaSenha.aspx", null, 1); ?>" ></iframe></div>',
                player: "html",
                title: "",
                height: 320,
                width: 520
            ...
            <div id="tudo">
                ...
                <div class="centro">
                    <div class="acesso">
                        ...
                        <div class="links">
                            <asp:Button Text="Entrar" ID="btnEntrar" ToolTip="Entrar" CssClass="btnsLogin" runat="server" 
