...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
        <div class="conteudo">
            ...
            <div class="box">
                <div class="seta-right"></div>
                <h2 class="efeito" title="Clique aqui para visualizar">Fichas Anteriores</h2>           
                <div class="togglebox">
                    <div class="bg-tabela-peq">
                         <asp:GridView ID="gvFichasAnteriores" CssClass="tabela-peq" AutoGenerateColumns="False" runat="server">
                                <Columns> 
                                    <asp:BoundField DataField="Data" HeaderText="Data de Vencimento" /> 
                                    <asp:BoundField DataField="Objetivo" HeaderText="Objetivo" />
                                    <asp:TemplateField HeaderText="Ação">  
