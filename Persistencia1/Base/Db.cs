...
namespace SIC.Persistencia.Base
{
    public static class Db
    {
        ...
        /// <returns></returns>
        public static T Read<T>(string sql, Func<IDataReader, T> make, CommandType commandType, List<DbParameter> parms, Usuario GetUsuario, bool autoRead = true)
        {
            int CodigoLog = GravarLogExecucao(GetUsuario.CodigoOrgao, GetUsuario.Codigo, GetUsuario.IP, sql, ConvertDbParameter(parms));
            ...
            {
                AtualizarLogExecucao(CodigoLog, ex.Message);
                return default(T);
            }
        ...
        /// <param name="parms"></param>
        /// <returns></returns>
        public static T Read<T>(string procName, Func<IDataReader, T> make, List<DbParameter> parms, Usuario GetUsuario, bool autoRead = true)
        {
            return Read<T>(procName, make, CommandType.StoredProcedure, parms, GetUsuario, autoRead);
        }
        ...
        /// <param name="parms"></param>
        /// <returns></returns>
        public static List<T> ReadList<T>(string sql, Func<IDataReader, T> make, CommandType commandType, List<DbParameter> parms, Usuario GetUsuario)
        {
            int CodigoLog = GravarLogExecucao(GetUsuario.CodigoOrgao, GetUsuario.Codigo, GetUsuario.IP, sql, ConvertDbParameter(parms));
        ...
        /// <param name="parms"></param>
        /// <returns></returns>
        public static List<T> ReadList<T>(string procName, Func<IDataReader, T> make, List<DbParameter> parms, Usuario GetUsuario)
        {
            return ReadList<T>(procName, make, CommandType.StoredProcedure, parms, GetUsuario);
        }
        ...
        /// <param name="parms"></param>
        /// <returns></returns>
        public static int GetCount(string sql, CommandType commandType, List<DbParameter> parms, Usuario GetUsuario)
        {
            return GetScalar(sql, commandType, parms, GetUsuario).AsInt();
        }
        ...
        /// <param name="parms"></param>
        /// <returns></returns>
        public static int GetCount(string procName, List<DbParameter> parms, Usuario GetUsuario)
        {
            return GetScalar(procName, parms, GetUsuario).AsInt();
        }
        ...
        /// <param name="parms"></param>
        /// <returns></returns>
        public static object GetScalar(string sql, CommandType commandType, List<DbParameter> parms, Usuario GetUsuario)
        {
            int CodigoLog = GravarLogExecucao(GetUsuario.CodigoOrgao, GetUsuario.Codigo, GetUsuario.IP, sql, ConvertDbParameter(parms));
        ...
        public static List<String> ReadList(string sql, CommandType commandType, List<DbParameter> parms, Usuario GetUsuario)
        {
            int CodigoLog = GravarLogExecucao(GetUsuario.CodigoOrgao, GetUsuario.Codigo, GetUsuario.IP, sql, ConvertDbParameter(parms));
        ...
        /// <param name="parms"></param>
        /// <returns></returns>
        public static object GetScalar(string procName, List<DbParameter> parms, Usuario GetUsuario)
        {
            return GetScalar(procName, CommandType.StoredProcedure, parms, GetUsuario);
        }
        ...
        /// <param name="parms"></param>
        /// <returns></returns>
        public static int Insert(string sql, CommandType commandType, List<DbParameter> parms, Usuario GetUsuario)
        {
            int CodigoLog = GravarLogExecucao(GetUsuario.CodigoOrgao, GetUsuario.Codigo, GetUsuario.IP, sql, ConvertDbParameter(parms));
        ...
        /// <param name="parms"></param>
        /// <returns></returns>
        public static int Insert(string procName, List<DbParameter> parms, Usuario GetUsuario)
        {
            return Insert(procName, CommandType.StoredProcedure, parms, GetUsuario);
        }
        ...
        /// <param name="sql"></param>
        /// <param name="parms"></param>
        public static void Update(string sql, CommandType commandType, List<DbParameter> parms, Usuario GetUsuario)
        {
            int CodigoLog = GravarLogExecucao(GetUsuario.CodigoOrgao, GetUsuario.Codigo, GetUsuario.IP, sql, ConvertDbParameter(parms));
        ...
        /// <param name="procName"></param>
        /// <param name="parms"></param>
        public static void Update(string procName, List<DbParameter> parms, Usuario GetUsuario)
        {
            Update(procName, CommandType.StoredProcedure, parms, GetUsuario);
        }
        /// <summary>
        ...
        /// <param name="sql"></param>
        /// <param name="parms"></param>
        public static void Delete(string sql, List<DbParameter> parms, Usuario GetUsuario)
        {
            Update(sql, parms, GetUsuario);
        }
