...
namespace SIC.Persistencia.Base
{
    public abstract class BaseDao<T> : IDao<T>
    {
        ...
        public virtual List<T> ObterLista(T filtro, Func<IDataReader, T> make)
        {
            ...
            return Db.ReadList(nomeProcedure, make, MontarParametros(filtro, cacheParametros), new Entidade.Usuario());
        }
        ...
        public void Inserir(T registro)
        {
            ...
            var chave = Db.Insert(nomeProcedure, parms, new Entidade.Usuario());
        ...
        public void Alterar(T registro)
        {
            ...
            Db.Update(nomeProcedure, parms, new Entidade.Usuario());
        }
        ...
        public void Excluir(T registro)
        {
            ...
            Db.Delete(nomeProcedure, parms, new Entidade.Usuario());
        }
